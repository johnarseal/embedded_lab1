...
000084cc <printnumk>:
    ...
    8548:	eb0001ea 	bl	8cf8 <__aeabi_uldivmod>
    ...
    8574:	eb0001df 	bl	8cf8 <__aeabi_uldivmod>
...
00008c48 <optimize_me>:
    ...
    8c5c:	ea00001d 	b	8cd8 <optimize_me+0x90>
    ...
    8c88:	e4843004 	str	r3, [r4], #4
    8c8c:	e1580007 	cmp	r8, r7
    8c90:	01a06003 	moveq	r6, r3
    8c94:	e2888001 	add	r8, r8, #1
    8c98:	e5943000 	ldr	r3, [r4]
    8c9c:	e0833203 	add	r3, r3, r3, lsl #4
    8ca0:	e2835013 	add	r5, r3, #19
    8ca4:	e2800019 	add	r0, r0, #25
    8ca8:	e0030096 	mul	r3, r6, r0
    8cac:	e0853003 	add	r3, r5, r3
    8cb0:	e3530000 	cmp	r3, #0
    8cb4:	b283300f 	addlt	r3, r3, #15
    8cb8:	e1a03243 	asr	r3, r3, #4
    8cbc:	e5843000 	str	r3, [r4]
    8cc0:	e1580007 	cmp	r8, r7
    8cc4:	01a06003 	moveq	r6, r3
    8cc8:	e2888001 	add	r8, r8, #1
    8ccc:	e3580f7d 	cmp	r8, #500	; 0x1f4
    8cd0:	baffffe2 	blt	8c60 <optimize_me+0x18>
    8cd4:	e2877001 	add	r7, r7, #1
    8cd8:	e2470019 	sub	r0, r7, #25
    8cdc:	e7996107 	ldr	r6, [r9, r7, lsl #2]
    8ce0:	e3570f7d 	cmp	r7, #500	; 0x1f4
    8ce4:	e3a08000 	mov	r8, #0
    8ce8:	baffffdc 	blt	8c60 <optimize_me+0x18>
    8cec:	e24bd010 	sub	sp, fp, #16
    8cf0:	e8bd4bf0 	pop	{r4, r5, r6, r7, r8, r9, fp, lr}
    8cf4:	e12fff1e 	bx	lr

00008cf8 <__aeabi_uldivmod>:
    8cf8:	e3530000 	cmp	r3, #0
    8cfc:	03520000 	cmpeq	r2, #0
    8d00:	1a000004 	bne	8d18 <__aeabi_uldivmod+0x20>
    8d04:	e3510000 	cmp	r1, #0
    8d08:	03500000 	cmpeq	r0, #0
    8d0c:	13e01000 	mvnne	r1, #0
    8d10:	13e00000 	mvnne	r0, #0
    8d14:	ea000027 	b	8db8 <__aeabi_idiv0>
    8d18:	e24dd008 	sub	sp, sp, #8
    8d1c:	e92d6000 	push	{sp, lr}
    8d20:	eb000014 	bl	8d78 <__gnu_uldivmod_helper>
    8d24:	e59de004 	ldr	lr, [sp, #4]
    8d28:	e28dd008 	add	sp, sp, #8
    8d2c:	e8bd000c 	pop	{r2, r3}
    8d30:	e12fff1e 	bx	lr

00008d34 <__gnu_ldivmod_helper>:
    8d34:	e92d47f0 	push	{r4, r5, r6, r7, r8, r9, sl, lr}
    8d38:	e59d6020 	ldr	r6, [sp, #32]
    8d3c:	e1a07002 	mov	r7, r2
    8d40:	e1a0a003 	mov	sl, r3
    8d44:	e1a04000 	mov	r4, r0
    8d48:	e1a05001 	mov	r5, r1
    8d4c:	eb00001a 	bl	8dbc <__divdi3>
    8d50:	e1a03000 	mov	r3, r0
    8d54:	e0020197 	mul	r2, r7, r1
    8d58:	e0898097 	umull	r8, r9, r7, r0
    8d5c:	e023239a 	mla	r3, sl, r3, r2
    8d60:	e0544008 	subs	r4, r4, r8
    8d64:	e0839009 	add	r9, r3, r9
    8d68:	e0c55009 	sbc	r5, r5, r9
    8d6c:	e8860030 	stm	r6, {r4, r5}
    8d70:	e8bd47f0 	pop	{r4, r5, r6, r7, r8, r9, sl, lr}
    8d74:	e12fff1e 	bx	lr

00008d78 <__gnu_uldivmod_helper>:
    8d78:	e92d41f0 	push	{r4, r5, r6, r7, r8, lr}
    8d7c:	e59d5018 	ldr	r5, [sp, #24]
    8d80:	e1a04002 	mov	r4, r2
    8d84:	e1a08003 	mov	r8, r3
    8d88:	e1a06000 	mov	r6, r0
    8d8c:	e1a07001 	mov	r7, r1
    8d90:	eb000067 	bl	8f34 <__udivdi3>
    8d94:	e0080890 	mul	r8, r0, r8
    8d98:	e0832490 	umull	r2, r3, r0, r4
    8d9c:	e0248491 	mla	r4, r1, r4, r8
    8da0:	e0566002 	subs	r6, r6, r2
    8da4:	e0843003 	add	r3, r4, r3
    8da8:	e0c77003 	sbc	r7, r7, r3
    8dac:	e88500c0 	stm	r5, {r6, r7}
    8db0:	e8bd41f0 	pop	{r4, r5, r6, r7, r8, lr}
    8db4:	e12fff1e 	bx	lr

00008db8 <__aeabi_idiv0>:
    8db8:	e12fff1e 	bx	lr

00008dbc <__divdi3>:
    8dbc:	e3510000 	cmp	r1, #0
    8dc0:	e92d4ff8 	push	{r3, r4, r5, r6, r7, r8, r9, sl, fp, lr}
    8dc4:	a1a04000 	movge	r4, r0
    8dc8:	a1a05001 	movge	r5, r1
    8dcc:	a3a0a000 	movge	sl, #0
    8dd0:	ba000053 	blt	8f24 <__divdi3+0x168>
    8dd4:	e3530000 	cmp	r3, #0
    8dd8:	a1a08002 	movge	r8, r2
    8ddc:	a1a09003 	movge	r9, r3
    8de0:	ba00004b 	blt	8f14 <__divdi3+0x158>
    8de4:	e1550009 	cmp	r5, r9
    8de8:	01540008 	cmpeq	r4, r8
    8dec:	33a02000 	movcc	r2, #0
    8df0:	33a03000 	movcc	r3, #0
    8df4:	3a00003b 	bcc	8ee8 <__divdi3+0x12c>
    8df8:	e1a01009 	mov	r1, r9
    8dfc:	e1a00008 	mov	r0, r8
    8e00:	eb000093 	bl	9054 <__clzdi2>
    8e04:	e1a01005 	mov	r1, r5
    8e08:	e1a0b000 	mov	fp, r0
    8e0c:	e1a00004 	mov	r0, r4
    8e10:	eb00008f 	bl	9054 <__clzdi2>
    8e14:	e060000b 	rsb	r0, r0, fp
    8e18:	e240e020 	sub	lr, r0, #32
    8e1c:	e1a07019 	lsl	r7, r9, r0
    8e20:	e1877e18 	orr	r7, r7, r8, lsl lr
    8e24:	e260c020 	rsb	ip, r0, #32
    8e28:	e1877c38 	orr	r7, r7, r8, lsr ip
    8e2c:	e1550007 	cmp	r5, r7
    8e30:	e1a06018 	lsl	r6, r8, r0
    8e34:	01540006 	cmpeq	r4, r6
    8e38:	e1a01000 	mov	r1, r0
    8e3c:	33a02000 	movcc	r2, #0
    8e40:	33a03000 	movcc	r3, #0
    8e44:	3a000005 	bcc	8e60 <__divdi3+0xa4>
    8e48:	e3a08001 	mov	r8, #1
    8e4c:	e0544006 	subs	r4, r4, r6
    8e50:	e1a03e18 	lsl	r3, r8, lr
    8e54:	e1833c38 	orr	r3, r3, r8, lsr ip
    8e58:	e0c55007 	sbc	r5, r5, r7
    8e5c:	e1a02018 	lsl	r2, r8, r0
    8e60:	e3500000 	cmp	r0, #0
    8e64:	0a00001f 	beq	8ee8 <__divdi3+0x12c>
    8e68:	e1b070a7 	lsrs	r7, r7, #1
    8e6c:	e1a06066 	rrx	r6, r6
    8e70:	ea000007 	b	8e94 <__divdi3+0xd8>
    8e74:	e0544006 	subs	r4, r4, r6
    8e78:	e0c55007 	sbc	r5, r5, r7
    8e7c:	e0944004 	adds	r4, r4, r4
    8e80:	e0a55005 	adc	r5, r5, r5
    8e84:	e2944001 	adds	r4, r4, #1
    8e88:	e2a55000 	adc	r5, r5, #0
    8e8c:	e2500001 	subs	r0, r0, #1
    8e90:	0a000006 	beq	8eb0 <__divdi3+0xf4>
    8e94:	e1570005 	cmp	r7, r5
    8e98:	01560004 	cmpeq	r6, r4
    8e9c:	9afffff4 	bls	8e74 <__divdi3+0xb8>
    8ea0:	e0944004 	adds	r4, r4, r4
    8ea4:	e0a55005 	adc	r5, r5, r5
    8ea8:	e2500001 	subs	r0, r0, #1
    8eac:	1afffff8 	bne	8e94 <__divdi3+0xd8>
    8eb0:	e261c020 	rsb	ip, r1, #32
    8eb4:	e1a00134 	lsr	r0, r4, r1
    8eb8:	e0922004 	adds	r2, r2, r4
    8ebc:	e241e020 	sub	lr, r1, #32
    8ec0:	e1800c15 	orr	r0, r0, r5, lsl ip
    8ec4:	e1a04135 	lsr	r4, r5, r1
    8ec8:	e1800e35 	orr	r0, r0, r5, lsr lr
    8ecc:	e1a07114 	lsl	r7, r4, r1
    8ed0:	e1877e10 	orr	r7, r7, r0, lsl lr
    8ed4:	e1a06110 	lsl	r6, r0, r1
    8ed8:	e0a33005 	adc	r3, r3, r5
    8edc:	e1877c30 	orr	r7, r7, r0, lsr ip
    8ee0:	e0522006 	subs	r2, r2, r6
    8ee4:	e0c33007 	sbc	r3, r3, r7
    8ee8:	e29a0000 	adds	r0, sl, #0
    8eec:	13a00001 	movne	r0, #1
    8ef0:	e3a01000 	mov	r1, #0
    8ef4:	e2704000 	rsbs	r4, r0, #0
    8ef8:	e2e15000 	rsc	r5, r1, #0
    8efc:	e0222004 	eor	r2, r2, r4
    8f00:	e0233005 	eor	r3, r3, r5
    8f04:	e0900002 	adds	r0, r0, r2
    8f08:	e0a11003 	adc	r1, r1, r3
    8f0c:	e8bd4ff8 	pop	{r3, r4, r5, r6, r7, r8, r9, sl, fp, lr}
    8f10:	e12fff1e 	bx	lr
    8f14:	e2728000 	rsbs	r8, r2, #0
    8f18:	e1e0a00a 	mvn	sl, sl
    8f1c:	e2e39000 	rsc	r9, r3, #0
    8f20:	eaffffaf 	b	8de4 <__divdi3+0x28>
    8f24:	e2704000 	rsbs	r4, r0, #0
    8f28:	e2e15000 	rsc	r5, r1, #0
    8f2c:	e3e0a000 	mvn	sl, #0
    8f30:	eaffffa7 	b	8dd4 <__divdi3+0x18>

00008f34 <__udivdi3>:
    8f34:	e1510003 	cmp	r1, r3
    8f38:	01500002 	cmpeq	r0, r2
    8f3c:	e92d47f0 	push	{r4, r5, r6, r7, r8, r9, sl, lr}
    8f40:	e1a04000 	mov	r4, r0
    8f44:	e1a05001 	mov	r5, r1
    8f48:	e1a08002 	mov	r8, r2
    8f4c:	e1a09003 	mov	r9, r3
    8f50:	33a00000 	movcc	r0, #0
    8f54:	33a01000 	movcc	r1, #0
    8f58:	3a00003b 	bcc	904c <__udivdi3+0x118>
    8f5c:	e1a01003 	mov	r1, r3
    8f60:	e1a00002 	mov	r0, r2
    8f64:	eb00003a 	bl	9054 <__clzdi2>
    8f68:	e1a01005 	mov	r1, r5
    8f6c:	e1a0a000 	mov	sl, r0
    8f70:	e1a00004 	mov	r0, r4
    8f74:	eb000036 	bl	9054 <__clzdi2>
    8f78:	e060300a 	rsb	r3, r0, sl
    8f7c:	e243e020 	sub	lr, r3, #32
    8f80:	e1a07319 	lsl	r7, r9, r3
    8f84:	e1877e18 	orr	r7, r7, r8, lsl lr
    8f88:	e263c020 	rsb	ip, r3, #32
    8f8c:	e1877c38 	orr	r7, r7, r8, lsr ip
    8f90:	e1550007 	cmp	r5, r7
    8f94:	e1a06318 	lsl	r6, r8, r3
    8f98:	01540006 	cmpeq	r4, r6
    8f9c:	e1a02003 	mov	r2, r3
    8fa0:	33a00000 	movcc	r0, #0
    8fa4:	33a01000 	movcc	r1, #0
    8fa8:	3a000005 	bcc	8fc4 <__udivdi3+0x90>
    8fac:	e3a08001 	mov	r8, #1
    8fb0:	e0544006 	subs	r4, r4, r6
    8fb4:	e1a01e18 	lsl	r1, r8, lr
    8fb8:	e1811c38 	orr	r1, r1, r8, lsr ip
    8fbc:	e0c55007 	sbc	r5, r5, r7
    8fc0:	e1a00318 	lsl	r0, r8, r3
    8fc4:	e3530000 	cmp	r3, #0
    8fc8:	0a00001f 	beq	904c <__udivdi3+0x118>
    8fcc:	e1b070a7 	lsrs	r7, r7, #1
    8fd0:	e1a06066 	rrx	r6, r6
    8fd4:	ea000007 	b	8ff8 <__udivdi3+0xc4>
    8fd8:	e0544006 	subs	r4, r4, r6
    8fdc:	e0c55007 	sbc	r5, r5, r7
    8fe0:	e0944004 	adds	r4, r4, r4
    8fe4:	e0a55005 	adc	r5, r5, r5
    8fe8:	e2944001 	adds	r4, r4, #1
    8fec:	e2a55000 	adc	r5, r5, #0
    8ff0:	e2533001 	subs	r3, r3, #1
    8ff4:	0a000006 	beq	9014 <__udivdi3+0xe0>
    8ff8:	e1570005 	cmp	r7, r5
    8ffc:	01560004 	cmpeq	r6, r4
    9000:	9afffff4 	bls	8fd8 <__udivdi3+0xa4>
    9004:	e0944004 	adds	r4, r4, r4
    9008:	e0a55005 	adc	r5, r5, r5
    900c:	e2533001 	subs	r3, r3, #1
    9010:	1afffff8 	bne	8ff8 <__udivdi3+0xc4>
    9014:	e0948000 	adds	r8, r4, r0
    9018:	e0a59001 	adc	r9, r5, r1
    901c:	e1a03234 	lsr	r3, r4, r2
    9020:	e2621020 	rsb	r1, r2, #32
    9024:	e2420020 	sub	r0, r2, #32
    9028:	e1833115 	orr	r3, r3, r5, lsl r1
    902c:	e1a0c235 	lsr	ip, r5, r2
    9030:	e1833035 	orr	r3, r3, r5, lsr r0
    9034:	e1a0721c 	lsl	r7, ip, r2
    9038:	e1877013 	orr	r7, r7, r3, lsl r0
    903c:	e1a06213 	lsl	r6, r3, r2
    9040:	e1877133 	orr	r7, r7, r3, lsr r1
    9044:	e0580006 	subs	r0, r8, r6
    9048:	e0c91007 	sbc	r1, r9, r7
    904c:	e8bd47f0 	pop	{r4, r5, r6, r7, r8, r9, sl, lr}
    9050:	e12fff1e 	bx	lr

00009054 <__clzdi2>:
    9054:	e92d4010 	push	{r4, lr}
    9058:	e3510000 	cmp	r1, #0
    905c:	1a000002 	bne	906c <__clzdi2+0x18>
    9060:	eb000005 	bl	907c <__clzsi2>
    9064:	e2800020 	add	r0, r0, #32
    9068:	ea000001 	b	9074 <__clzdi2+0x20>
    906c:	e1a00001 	mov	r0, r1
    9070:	eb000001 	bl	907c <__clzsi2>
    9074:	e8bd4010 	pop	{r4, lr}
    9078:	e12fff1e 	bx	lr

0000907c <__clzsi2>:
    907c:	e3a0101c 	mov	r1, #28
    9080:	e3500801 	cmp	r0, #65536	; 0x10000
    9084:	21a00820 	lsrcs	r0, r0, #16
    9088:	22411010 	subcs	r1, r1, #16
    908c:	e3500c01 	cmp	r0, #256	; 0x100
    9090:	21a00420 	lsrcs	r0, r0, #8
    9094:	22411008 	subcs	r1, r1, #8
    9098:	e3500010 	cmp	r0, #16
    909c:	21a00220 	lsrcs	r0, r0, #4
    90a0:	22411004 	subcs	r1, r1, #4
    90a4:	e28f2008 	add	r2, pc, #8
    90a8:	e7d20000 	ldrb	r0, [r2, r0]
    90ac:	e0800001 	add	r0, r0, r1
    90b0:	e12fff1e 	bx	lr
    90b4:	02020304 	andeq	r0, r2, #4, 6	; 0x10000000
    90b8:	01010101 	tsteq	r1, r1, lsl #2
	...
...
0000a08c <.ARM.exidx>:
    a08c:	7fffed30 	svcvc	0x00ffed30
...
00000000 <.debug_info>:
     ...
     814:	008cf800 	addeq	pc, ip, r0, lsl #16
     ...
     870:	45010400 	strmi	r0, [r1, #-1024]	; 0xfffffc00
     874:	f8000005 			; <UNDEFINED> instruction: 0xf8000005
     878:	3400008c 	strcc	r0, [r0], #-140	; 0xffffff74
     ...
     928:	8d340000 	ldchi	0, cr0, [r4, #-0]
     92c:	00840000 	addeq	r0, r4, r0
     930:	05a30000 	streq	r0, [r3, #0]!
     ...
     948:	00008d34 	andeq	r8, r0, r4, lsr sp
     ...
     9cc:	78000000 	stmdavc	r0, {}	; <UNPREDICTABLE>
     ...
     a80:	00060201 	andeq	r0, r6, r1, lsl #4
     a84:	008db800 	addeq	fp, sp, r0, lsl #16
     a88:	008dbc00 	addeq	fp, sp, r0, lsl #24
     ...
     b3c:	00008dbc 			; <UNDEFINED> instruction: 0x00008dbc
     b40:	00000178 	andeq	r0, r0, r8, ror r1
     b44:	0000065d 	andeq	r0, r0, sp, asr r6
     ...
     cbc:	008dbc00 	addeq	fp, sp, r0, lsl #24
     ...
     d40:	008de414 	addeq	lr, sp, r4, lsl r4
     ...
     da4:	008f3400 	addeq	r3, pc, r0, lsl #8
     da8:	00012000 	andeq	r2, r1, r0
     dac:	0006f500 	andeq	pc, r6, r0, lsl #10
     ...
     ebc:	008f3400 	addeq	r3, pc, r0, lsl #8
     ...
     ee8:	00008f34 	andeq	r8, r0, r4, lsr pc
     ...
     f5c:	87010400 	strhi	r0, [r1, -r0, lsl #8]
     f60:	54000007 	strpl	r0, [r0], #-7
     f64:	7c000090 	stcvc	0, cr0, [r0], {144}	; 0x90
    ...
    100c:	0007ec01 	andeq	lr, r7, r1, lsl #24
    1010:	00907c00 	addseq	r7, r0, r0, lsl #24
    1014:	0090c400 	addseq	ip, r0, r0, lsl #8
...
00000000 <.debug_abbrev>:
 ...
 174:	0b002404 	bleq	918c <__clzsi2+0x110>
 ...
 26c:	0b002403 	bleq	9280 <__clzsi2+0x204>
 ...
 3a8:	0b002403 	bleq	93bc <__clzsi2+0x340>
 ...
 544:	0b002402 	bleq	9554 <__clzsi2+0x4d8>
...
00000000 <.debug_aranges>:
 ...
 150:	00008cf8 	strdeq	r8, [r0], -r8	; <UNPREDICTABLE>
 ...
 170:	00008d34 	andeq	r8, r0, r4, lsr sp
 ...
 190:	00008db8 			; <UNDEFINED> instruction: 0x00008db8
 ...
 1b0:	00008dbc 			; <UNDEFINED> instruction: 0x00008dbc
 ...
 1d0:	00008f34 	andeq	r8, r0, r4, lsr pc
 ...
 1f0:	00009054 	andeq	r9, r0, r4, asr r0
 ...
 210:	0000907c 	andeq	r9, r0, ip, ror r0
...
00000000 <.debug_line>:
 ...
 4dc:	00006401 	andeq	r6, r0, r1, lsl #8
 ...
 528:	322f2f32 	eorcc	r2, pc, #50, 30	; 0xc8
 52c:	2f302f31 	svccs	0x00302f31
 530:	2f312f30 	svccs	0x00312f30
 534:	302f322f 	eorcc	r3, pc, pc, lsr #4
 538:	2f302f30 	svccs	0x00302f30
 53c:	2f30302f 	svccs	0x0030302f
 540:	01000202 	tsteq	r0, r2, lsl #4
 544:	00005a01 	andeq	r5, r0, r1, lsl #20
 548:	3d000200 	sfmcc	f0, 4, [r0, #-0]
 54c:	02000000 	andeq	r0, r0, #0
 550:	0d0efb01 	vstreq	d15, [lr, #-4]
 554:	01010100 	mrseq	r0, (UNDEF: 17)
 558:	00000001 	andeq	r0, r0, r1
 55c:	01000001 	tsteq	r0, r1
 560:	2e2f2e2e 	cdpcs	14, 2, cr2, cr15, cr14, {1}
 564:	2e2e2f2e 	cdpcs	15, 2, cr2, cr14, cr14, {1}
 568:	6372732f 	cmnvs	r2, #-1140850688	; 0xbc000000
 56c:	62696c2f 	rsbvs	r6, r9, #12032	; 0x2f00
 570:	2f636367 	svccs	0x00636367
 574:	666e6f63 	strbtvs	r6, [lr], -r3, ror #30
 578:	612f6769 			; <UNDEFINED> instruction: 0x612f6769
 57c:	00006d72 	andeq	r6, r0, r2, ror sp
 580:	62617062 	rsbvs	r7, r1, #98	; 0x62
 584:	00532e69 	subseq	r2, r3, r9, ror #28
 588:	00000001 	andeq	r0, r0, r1
 58c:	f8020500 			; <UNDEFINED> instruction: 0xf8020500
 590:	0300008c 	movweq	r0, #140	; 0x8c
 594:	f401019b 	vst4.32	{d0,d2,d4,d6}, [r1 :64], fp
 598:	2f2f3133 	svccs	0x002f3133
 59c:	02022f2f 	andeq	r2, r2, #47, 30	; 0xbc
 5a0:	5b010100 	blpl	409a8 <__bss_end+0x339a8>
 5a4:	02000000 	andeq	r0, r0, #0
 5a8:	00003d00 	andeq	r3, r0, r0, lsl #26
 5ac:	fb010200 	blx	40db6 <__bss_end+0x33db6>
 5b0:	01000d0e 	tsteq	r0, lr, lsl #26
 5b4:	00010101 	andeq	r0, r1, r1, lsl #2
 5b8:	00010000 	andeq	r0, r1, r0
 5bc:	2e2e0100 	sufcse	f0, f6, f0
 5c0:	2f2e2e2f 	svccs	0x002e2e2f
 5c4:	732f2e2e 			; <UNDEFINED> instruction: 0x732f2e2e
 5c8:	6c2f6372 	stcvs	3, cr6, [pc], #-456	; 408 <__start-0x7bf8>
 5cc:	63676269 	cmnvs	r7, #-1879048186	; 0x90000006
 5d0:	6f632f63 	svcvs	0x00632f63
 5d4:	6769666e 	strbvs	r6, [r9, -lr, ror #12]!
 5d8:	6d72612f 	ldfvse	f6, [r2, #-188]!	; 0xffffff44
 5dc:	70620000 	rsbvc	r0, r2, r0
 5e0:	2e696261 	cdpcs	2, 6, cr6, cr9, cr1, {3}
 5e4:	00010063 	andeq	r0, r1, r3, rrx
 5e8:	05000000 	streq	r0, [r0, #-0]
 5ec:	008d3402 	addeq	r3, sp, r2, lsl #8
 5f0:	01250300 			; <UNDEFINED> instruction: 0x01250300
 5f4:	d84ba12e 	stmdale	fp, {r1, r2, r3, r5, r8, sp, pc}^
 5f8:	2fa12e50 	svccs	0x00a12e50
 5fc:	000402d8 	ldrdeq	r0, [r4], -r8
 600:	00570101 	subseq	r0, r7, r1, lsl #2
 604:	00020000 	andeq	r0, r2, r0
 608:	00000041 	andeq	r0, r0, r1, asr #32
 ...
 61c:	2f2e2e01 	svccs	0x002e2e01
 620:	2e2f2e2e 	cdpcs	14, 2, cr2, cr15, cr14, {1}
 624:	72732f2e 	rsbsvc	r2, r3, #46, 30	; 0xb8
 628:	696c2f63 	stmdbvs	ip!, {r0, r1, r5, r6, r8, r9, sl, fp, sp}^
 62c:	63636762 	cmnvs	r3, #25690112	; 0x1880000
 630:	6e6f632f 	cdpvs	3, 6, cr6, cr15, cr15, {1}
 634:	2f676966 	svccs	0x00676966
 638:	006d7261 	rsbeq	r7, sp, r1, ror #4
 63c:	62696c00 	rsbvs	r6, r9, #0, 24
 640:	6e756631 	mrcvs	6, 3, r6, cr5, cr1, {1}
 644:	532e7363 			; <UNDEFINED> instruction: 0x532e7363
 648:	00000100 	andeq	r0, r0, r0, lsl #2
 64c:	02050000 	andeq	r0, r5, #0
 650:	00008db8 			; <UNDEFINED> instruction: 0x00008db8
 654:	010bae03 	tsteq	fp, r3, lsl #28
 658:	01000202 	tsteq	r0, r2, lsl #4
 65c:	00009401 	andeq	r9, r0, r1, lsl #8
 660:	41000200 	mrsmi	r0, R8_usr
 664:	02000000 	andeq	r0, r0, #0
 668:	0d0efb01 	vstreq	d15, [lr, #-4]
 66c:	01010100 	mrseq	r0, (UNDEF: 17)
 ...
 680:	6372732f 	cmnvs	r2, #-1140850688	; 0xbc000000
 684:	62696c2f 	rsbvs	r6, r9, #12032	; 0x2f00
 688:	00636367 	rsbeq	r6, r3, r7, ror #6
 68c:	62696c00 	rsbvs	r6, r9, #0, 24
 690:	32636367 	rsbcc	r6, r3, #-1677721599	; 0x9c000001
 694:	0100632e 	tsteq	r0, lr, lsr #6
 698:	696c0000 	stmdbvs	ip!, {}^	; <UNPREDICTABLE>
 69c:	63636762 	cmnvs	r3, #25690112	; 0x1880000
 6a0:	00682e32 	rsbeq	r2, r8, r2, lsr lr
 6a4:	00000001 	andeq	r0, r0, r1
 6a8:	bc020500 	cfstr32lt	mvfx0, [r2], {-0}
 6ac:	0300008d 	movweq	r0, #141	; 0x8d
 6b0:	180109cb 	stmdane	r1, {r0, r1, r3, r6, r7, r8, fp}
 6b4:	672e7a03 	strvs	r7, [lr, -r3, lsl #20]!
 6b8:	e8033133 	stmda	r3, {r0, r1, r4, r5, r8, ip, sp}
 6bc:	67a0827d 			; <UNDEFINED> instruction: 0x67a0827d
 6c0:	2f4c2f2d 	svccs	0x004c2f2d
 6c4:	2e7903a5 	cdpcs	3, 7, cr0, cr9, cr5, {5}
 6c8:	2e790335 	mrccs	3, 3, r0, cr9, cr5, {1}
 6cc:	032e6f03 			; <UNDEFINED> instruction: 0x032e6f03
 6d0:	2d314a18 	vldmdbcs	r1!, {s8-s31}
 6d4:	312f492f 			; <UNDEFINED> instruction: 0x312f492f
 6d8:	45be6e4c 	ldrmi	r6, [lr, #3660]!	; 0xe4c
 6dc:	494f4c69 	stmdbmi	pc, {r0, r3, r5, r6, sl, fp, lr}^	; <UNPREDICTABLE>
 6e0:	3064832f 	rsbcc	r8, r4, pc, lsr #6
 6e4:	0801fa03 	stmdaeq	r1, {r0, r1, r9, fp, ip, sp, lr, pc}
 6e8:	8279033c 	rsbshi	r0, r9, #60, 6	; 0xf0000000
 6ec:	49472f2d 	stmdbmi	r7, {r0, r2, r3, r5, r8, r9, sl, fp, sp}^
 6f0:	01000402 	tsteq	r0, r2, lsl #8
 6f4:	00008e01 	andeq	r8, r0, r1, lsl #28
 6f8:	41000200 	mrsmi	r0, R8_usr
 ...
 710:	2e2f2e2e 	cdpcs	14, 2, cr2, cr15, cr14, {1}
 714:	2e2e2f2e 	cdpcs	15, 2, cr2, cr14, cr14, {1}
 718:	6372732f 	cmnvs	r2, #-1140850688	; 0xbc000000
 71c:	62696c2f 	rsbvs	r6, r9, #12032	; 0x2f00
 720:	00636367 	rsbeq	r6, r3, r7, ror #6
 ...
 734:	63636762 	cmnvs	r3, #25690112	; 0x1880000
 738:	00682e32 	rsbeq	r2, r8, r2, lsr lr
 73c:	00000001 	andeq	r0, r0, r1
 740:	34020500 	strcc	r0, [r2], #-1280	; 0xfffffb00
 744:	0300008f 	movweq	r0, #143	; 0x8f
 748:	03010a86 	movweq	r0, #6790	; 0x1a86
 74c:	03017db6 	movweq	r7, #7606	; 0x1db6
 750:	2e4a02ca 	cdpcs	2, 4, cr0, cr10, cr10, {6}
 754:	827dab03 	rsbshi	sl, sp, #3072	; 0xc00
 758:	304a0b03 	subcc	r0, sl, r3, lsl #22
 75c:	4c2f2d67 	stcmi	13, cr2, [pc], #-412	; 5c8 <__start-0x7a38>
 760:	7903a52f 	stmdbvc	r3, {r0, r1, r2, r3, r5, r8, sl, sp, pc}
 764:	7903352e 	stmdbvc	r3, {r1, r2, r3, r5, r8, sl, ip, sp}
 768:	2e6f032e 	cdpcs	3, 6, cr0, cr15, cr14, {1}
 76c:	314a1803 	cmpcc	sl, r3, lsl #16
 770:	2f492f2d 	svccs	0x00492f2d
 774:	be6e4c31 	mcrlt	12, 3, r4, cr14, cr1, {1}
 778:	4e4c6945 	cdpmi	9, 4, cr6, cr12, cr5, {2}
 77c:	a503bb4b 	strge	fp, [r3, #-2891]	; 0xfffff4b5
 780:	0402ba02 	streq	fp, [r2], #-2562	; 0xfffff5fe
 784:	61010100 	mrsvs	r0, (UNDEF: 17)
 788:	02000000 	andeq	r0, r0, #0
 78c:	00004100 	andeq	r4, r0, r0, lsl #2
 790:	fb010200 	blx	40f9a <__bss_end+0x33f9a>
 794:	01000d0e 	tsteq	r0, lr, lsl #26
 798:	00010101 	andeq	r0, r1, r1, lsl #2
 79c:	00010000 	andeq	r0, r1, r0
 7a0:	2e2e0100 	sufcse	f0, f6, f0
 7a4:	2f2e2e2f 	svccs	0x002e2e2f
 7a8:	732f2e2e 			; <UNDEFINED> instruction: 0x732f2e2e
 7ac:	6c2f6372 	stcvs	3, cr6, [pc], #-456	; 5ec <__start-0x7a14>
 ...
 7c0:	696c0000 	stmdbvs	ip!, {}^	; <UNPREDICTABLE>
 7c4:	75663162 	strbvc	r3, [r6, #-354]!	; 0xfffffe9e
 7c8:	2e73636e 	cdpcs	3, 7, cr6, cr3, cr14, {3}
 7cc:	00010053 	andeq	r0, r1, r3, asr r0
 7d0:	05000000 	streq	r0, [r0, #-0]
 7d4:	00905402 	addseq	r5, r0, r2, lsl #8
 7d8:	0dae0300 	stceq	3, cr0, [lr]
 7dc:	032f3001 			; <UNDEFINED> instruction: 0x032f3001
 7e0:	2f2f2e09 	svccs	0x002f2e09
 7e4:	02342f30 	eorseq	r2, r4, #48, 30	; 0xc0
 7e8:	01010004 	tsteq	r1, r4
 7ec:	00000064 	andeq	r0, r0, r4, rrx
 7f0:	00410002 	subeq	r0, r1, r2
 7f4:	01020000 	mrseq	r0, (UNDEF: 2)
 7f8:	000d0efb 	strdeq	r0, [sp], -fp
 7fc:	01010101 	tsteq	r1, r1, lsl #2
 800:	01000000 	mrseq	r0, (UNDEF: 0)
 804:	2e010000 	cdpcs	0, 0, cr0, cr1, cr0, {0}
 808:	2e2e2f2e 	cdpcs	15, 2, cr2, cr14, cr14, {1}
 80c:	2f2e2e2f 	svccs	0x002e2e2f
 810:	2f637273 	svccs	0x00637273
 814:	6762696c 	strbvs	r6, [r2, -ip, ror #18]!
 818:	632f6363 			; <UNDEFINED> instruction: 0x632f6363
 81c:	69666e6f 	stmdbvs	r6!, {r0, r1, r2, r3, r5, r6, r9, sl, fp, sp, lr}^
 820:	72612f67 	rsbvc	r2, r1, #412	; 0x19c
 824:	6c00006d 	stcvs	0, cr0, [r0], {109}	; 0x6d
 828:	66316269 	ldrtvs	r6, [r1], -r9, ror #4
 82c:	73636e75 	cmnvc	r3, #1872	; 0x750
 830:	0100532e 	tsteq	r0, lr, lsr #6
 834:	00000000 	andeq	r0, r0, r0
 838:	907c0205 	rsbsls	r0, ip, r5, lsl #4
 83c:	8d030000 	stchi	0, cr0, [r3, #-0]
 840:	302f010d 	eorcc	r0, pc, sp, lsl #2
 844:	2f302f2f 	svccs	0x00302f2f
 848:	2f2f302f 	svccs	0x002f302f
 84c:	022f2f2f 	eoreq	r2, pc, #47, 30	; 0xbc
...
00000000 <.debug_frame>:
 ...
 2cc:	00008cf8 	strdeq	r8, [r0], -r8	; <UNPREDICTABLE>
 ...
 2f4:	00008d34 	andeq	r8, r0, r4, lsr sp
 ...
 324:	00008d78 	andeq	r8, r0, r8, ror sp
 ...
 35c:	00008dbc 			; <UNDEFINED> instruction: 0x00008dbc
 ...
 3a4:	00008f34 	andeq	r8, r0, r4, lsr pc
