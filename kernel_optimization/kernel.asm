...
00008c48 <optimize_me>:
    ...
    8c5c:	ea00000f 	b	8ca0 <optimize_me+0x58>
    8c60:	e5943000 	ldr	r3, [r4]
    8c64:	e2800019 	add	r0, r0, #25
    8c68:	e0833203 	add	r3, r3, r3, lsl #4
    8c6c:	e2835013 	add	r5, r3, #19
    8c70:	e0030096 	mul	r3, r6, r0
    8c74:	e0853003 	add	r3, r5, r3
    ...
    8c98:	bafffff0 	blt	8c60 <optimize_me+0x18>
    8c9c:	e2877001 	add	r7, r7, #1
    8ca0:	e2470019 	sub	r0, r7, #25
    8ca4:	e7916107 	ldr	r6, [r1, r7, lsl #2]
...
00000000 <.debug_line>:
 ...
 524:	302f2f31 	eorcc	r2, pc, r1, lsr pc	; <UNPREDICTABLE>
 528:	2f30302f 	svccs	0x0030302f
