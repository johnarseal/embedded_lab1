...
000084cc <printnumk>:
    ...
    8548:	eb0001e0 	bl	8cd0 <__aeabi_uldivmod>
    ...
    8574:	eb0001d5 	bl	8cd0 <__aeabi_uldivmod>
...
00008c48 <optimize_me>:
    8c48:	e92d4ff0 	push	{r4, r5, r6, r7, r8, r9, sl, fp, lr}
    8c4c:	e28db010 	add	fp, sp, #16
    8c50:	e24dd01c 	sub	sp, sp, #28
    8c54:	e1a09000 	mov	r9, r0
    8c58:	e3a07000 	mov	r7, #0
    8c5c:	e3e0a019 	mvn	sl, #25
    8c60:	e1a01000 	mov	r1, r0
    8c64:	ea00000f 	b	8ca8 <optimize_me+0x60>
    8c68:	e5943000 	ldr	r3, [r4]
    8c6c:	e0833203 	add	r3, r3, r3, lsl #4
    8c70:	e2835013 	add	r5, r3, #19
    8c74:	e2800019 	add	r0, r0, #25
    8c78:	e0030096 	mul	r3, r6, r0
    8c7c:	e0853003 	add	r3, r5, r3
    8c80:	e3530000 	cmp	r3, #0
    8c84:	b283300f 	addlt	r3, r3, #15
    8c88:	e1a03243 	asr	r3, r3, #4
    8c8c:	e4843004 	str	r3, [r4], #4
    8c90:	e1580007 	cmp	r8, r7
    8c94:	01a06003 	moveq	r6, r3
    8c98:	e2888001 	add	r8, r8, #1
    8c9c:	e3580f7d 	cmp	r8, #500	; 0x1f4
    8ca0:	bafffff0 	blt	8c68 <optimize_me+0x20>
    8ca4:	e2877001 	add	r7, r7, #1
    8ca8:	e28aa001 	add	sl, sl, #1
    8cac:	e1a0000a 	mov	r0, sl
    8cb0:	e4916004 	ldr	r6, [r1], #4
    8cb4:	e3570f7d 	cmp	r7, #500	; 0x1f4
    8cb8:	e3a08000 	mov	r8, #0
    8cbc:	e1a04009 	mov	r4, r9
    8cc0:	baffffe8 	blt	8c68 <optimize_me+0x20>
    8cc4:	e24bd010 	sub	sp, fp, #16
    8cc8:	e8bd4ff0 	pop	{r4, r5, r6, r7, r8, r9, sl, fp, lr}
    8ccc:	e12fff1e 	bx	lr

00008cd0 <__aeabi_uldivmod>:
    8cd0:	e3530000 	cmp	r3, #0
    8cd4:	03520000 	cmpeq	r2, #0
    8cd8:	1a000004 	bne	8cf0 <__aeabi_uldivmod+0x20>
    8cdc:	e3510000 	cmp	r1, #0
    8ce0:	03500000 	cmpeq	r0, #0
    8ce4:	13e01000 	mvnne	r1, #0
    8ce8:	13e00000 	mvnne	r0, #0
    8cec:	ea000027 	b	8d90 <__aeabi_idiv0>
    8cf0:	e24dd008 	sub	sp, sp, #8
    8cf4:	e92d6000 	push	{sp, lr}
    8cf8:	eb000014 	bl	8d50 <__gnu_uldivmod_helper>
    8cfc:	e59de004 	ldr	lr, [sp, #4]
    8d00:	e28dd008 	add	sp, sp, #8
    8d04:	e8bd000c 	pop	{r2, r3}
    8d08:	e12fff1e 	bx	lr

00008d0c <__gnu_ldivmod_helper>:
    8d0c:	e92d47f0 	push	{r4, r5, r6, r7, r8, r9, sl, lr}
    8d10:	e59d6020 	ldr	r6, [sp, #32]
    8d14:	e1a07002 	mov	r7, r2
    8d18:	e1a0a003 	mov	sl, r3
    8d1c:	e1a04000 	mov	r4, r0
    8d20:	e1a05001 	mov	r5, r1
    8d24:	eb00001a 	bl	8d94 <__divdi3>
    8d28:	e1a03000 	mov	r3, r0
    8d2c:	e0020197 	mul	r2, r7, r1
    8d30:	e0898097 	umull	r8, r9, r7, r0
    8d34:	e023239a 	mla	r3, sl, r3, r2
    8d38:	e0544008 	subs	r4, r4, r8
    8d3c:	e0839009 	add	r9, r3, r9
    8d40:	e0c55009 	sbc	r5, r5, r9
    8d44:	e8860030 	stm	r6, {r4, r5}
    8d48:	e8bd47f0 	pop	{r4, r5, r6, r7, r8, r9, sl, lr}
    8d4c:	e12fff1e 	bx	lr

00008d50 <__gnu_uldivmod_helper>:
    8d50:	e92d41f0 	push	{r4, r5, r6, r7, r8, lr}
    8d54:	e59d5018 	ldr	r5, [sp, #24]
    8d58:	e1a04002 	mov	r4, r2
    8d5c:	e1a08003 	mov	r8, r3
    8d60:	e1a06000 	mov	r6, r0
    8d64:	e1a07001 	mov	r7, r1
    8d68:	eb000067 	bl	8f0c <__udivdi3>
    8d6c:	e0080890 	mul	r8, r0, r8
    8d70:	e0832490 	umull	r2, r3, r0, r4
    8d74:	e0248491 	mla	r4, r1, r4, r8
    8d78:	e0566002 	subs	r6, r6, r2
    8d7c:	e0843003 	add	r3, r4, r3
    8d80:	e0c77003 	sbc	r7, r7, r3
    8d84:	e88500c0 	stm	r5, {r6, r7}
    8d88:	e8bd41f0 	pop	{r4, r5, r6, r7, r8, lr}
    8d8c:	e12fff1e 	bx	lr
...
00008d94 <__divdi3>:
    ...
    8d98:	e92d4ff8 	push	{r3, r4, r5, r6, r7, r8, r9, sl, fp, lr}
    8d9c:	a1a04000 	movge	r4, r0
    8da0:	a1a05001 	movge	r5, r1
    8da4:	a3a0a000 	movge	sl, #0
    8da8:	ba000053 	blt	8efc <__divdi3+0x168>
    8dac:	e3530000 	cmp	r3, #0
    8db0:	a1a08002 	movge	r8, r2
    8db4:	a1a09003 	movge	r9, r3
    8db8:	ba00004b 	blt	8eec <__divdi3+0x158>
    8dbc:	e1550009 	cmp	r5, r9
    8dc0:	01540008 	cmpeq	r4, r8
    8dc4:	33a02000 	movcc	r2, #0
    8dc8:	33a03000 	movcc	r3, #0
    8dcc:	3a00003b 	bcc	8ec0 <__divdi3+0x12c>
    8dd0:	e1a01009 	mov	r1, r9
    8dd4:	e1a00008 	mov	r0, r8
    8dd8:	eb000093 	bl	902c <__clzdi2>
    8ddc:	e1a01005 	mov	r1, r5
    8de0:	e1a0b000 	mov	fp, r0
    8de4:	e1a00004 	mov	r0, r4
    8de8:	eb00008f 	bl	902c <__clzdi2>
    8dec:	e060000b 	rsb	r0, r0, fp
    8df0:	e240e020 	sub	lr, r0, #32
    8df4:	e1a07019 	lsl	r7, r9, r0
    8df8:	e1877e18 	orr	r7, r7, r8, lsl lr
    8dfc:	e260c020 	rsb	ip, r0, #32
    8e00:	e1877c38 	orr	r7, r7, r8, lsr ip
    8e04:	e1550007 	cmp	r5, r7
    8e08:	e1a06018 	lsl	r6, r8, r0
    8e0c:	01540006 	cmpeq	r4, r6
    8e10:	e1a01000 	mov	r1, r0
    8e14:	33a02000 	movcc	r2, #0
    8e18:	33a03000 	movcc	r3, #0
    8e1c:	3a000005 	bcc	8e38 <__divdi3+0xa4>
    8e20:	e3a08001 	mov	r8, #1
    8e24:	e0544006 	subs	r4, r4, r6
    8e28:	e1a03e18 	lsl	r3, r8, lr
    8e2c:	e1833c38 	orr	r3, r3, r8, lsr ip
    8e30:	e0c55007 	sbc	r5, r5, r7
    8e34:	e1a02018 	lsl	r2, r8, r0
    8e38:	e3500000 	cmp	r0, #0
    8e3c:	0a00001f 	beq	8ec0 <__divdi3+0x12c>
    8e40:	e1b070a7 	lsrs	r7, r7, #1
    8e44:	e1a06066 	rrx	r6, r6
    8e48:	ea000007 	b	8e6c <__divdi3+0xd8>
    8e4c:	e0544006 	subs	r4, r4, r6
    8e50:	e0c55007 	sbc	r5, r5, r7
    8e54:	e0944004 	adds	r4, r4, r4
    8e58:	e0a55005 	adc	r5, r5, r5
    8e5c:	e2944001 	adds	r4, r4, #1
    8e60:	e2a55000 	adc	r5, r5, #0
    8e64:	e2500001 	subs	r0, r0, #1
    8e68:	0a000006 	beq	8e88 <__divdi3+0xf4>
    8e6c:	e1570005 	cmp	r7, r5
    8e70:	01560004 	cmpeq	r6, r4
    8e74:	9afffff4 	bls	8e4c <__divdi3+0xb8>
    8e78:	e0944004 	adds	r4, r4, r4
    8e7c:	e0a55005 	adc	r5, r5, r5
    8e80:	e2500001 	subs	r0, r0, #1
    8e84:	1afffff8 	bne	8e6c <__divdi3+0xd8>
    8e88:	e261c020 	rsb	ip, r1, #32
    8e8c:	e1a00134 	lsr	r0, r4, r1
    8e90:	e0922004 	adds	r2, r2, r4
    8e94:	e241e020 	sub	lr, r1, #32
    8e98:	e1800c15 	orr	r0, r0, r5, lsl ip
    8e9c:	e1a04135 	lsr	r4, r5, r1
    8ea0:	e1800e35 	orr	r0, r0, r5, lsr lr
    8ea4:	e1a07114 	lsl	r7, r4, r1
    8ea8:	e1877e10 	orr	r7, r7, r0, lsl lr
    8eac:	e1a06110 	lsl	r6, r0, r1
    8eb0:	e0a33005 	adc	r3, r3, r5
    8eb4:	e1877c30 	orr	r7, r7, r0, lsr ip
    8eb8:	e0522006 	subs	r2, r2, r6
    8ebc:	e0c33007 	sbc	r3, r3, r7
    8ec0:	e29a0000 	adds	r0, sl, #0
    8ec4:	13a00001 	movne	r0, #1
    8ec8:	e3a01000 	mov	r1, #0
    8ecc:	e2704000 	rsbs	r4, r0, #0
    8ed0:	e2e15000 	rsc	r5, r1, #0
    8ed4:	e0222004 	eor	r2, r2, r4
    8ed8:	e0233005 	eor	r3, r3, r5
    8edc:	e0900002 	adds	r0, r0, r2
    8ee0:	e0a11003 	adc	r1, r1, r3
    8ee4:	e8bd4ff8 	pop	{r3, r4, r5, r6, r7, r8, r9, sl, fp, lr}
    8ee8:	e12fff1e 	bx	lr
    8eec:	e2728000 	rsbs	r8, r2, #0
    8ef0:	e1e0a00a 	mvn	sl, sl
    8ef4:	e2e39000 	rsc	r9, r3, #0
    8ef8:	eaffffaf 	b	8dbc <__divdi3+0x28>
    8efc:	e2704000 	rsbs	r4, r0, #0
    8f00:	e2e15000 	rsc	r5, r1, #0
    8f04:	e3e0a000 	mvn	sl, #0
    8f08:	eaffffa7 	b	8dac <__divdi3+0x18>

00008f0c <__udivdi3>:
    8f0c:	e1510003 	cmp	r1, r3
    8f10:	01500002 	cmpeq	r0, r2
    8f14:	e92d47f0 	push	{r4, r5, r6, r7, r8, r9, sl, lr}
    8f18:	e1a04000 	mov	r4, r0
    8f1c:	e1a05001 	mov	r5, r1
    8f20:	e1a08002 	mov	r8, r2
    8f24:	e1a09003 	mov	r9, r3
    8f28:	33a00000 	movcc	r0, #0
    8f2c:	33a01000 	movcc	r1, #0
    8f30:	3a00003b 	bcc	9024 <__udivdi3+0x118>
    8f34:	e1a01003 	mov	r1, r3
    8f38:	e1a00002 	mov	r0, r2
    8f3c:	eb00003a 	bl	902c <__clzdi2>
    8f40:	e1a01005 	mov	r1, r5
    8f44:	e1a0a000 	mov	sl, r0
    8f48:	e1a00004 	mov	r0, r4
    8f4c:	eb000036 	bl	902c <__clzdi2>
    8f50:	e060300a 	rsb	r3, r0, sl
    8f54:	e243e020 	sub	lr, r3, #32
    8f58:	e1a07319 	lsl	r7, r9, r3
    8f5c:	e1877e18 	orr	r7, r7, r8, lsl lr
    8f60:	e263c020 	rsb	ip, r3, #32
    8f64:	e1877c38 	orr	r7, r7, r8, lsr ip
    8f68:	e1550007 	cmp	r5, r7
    8f6c:	e1a06318 	lsl	r6, r8, r3
    8f70:	01540006 	cmpeq	r4, r6
    8f74:	e1a02003 	mov	r2, r3
    8f78:	33a00000 	movcc	r0, #0
    8f7c:	33a01000 	movcc	r1, #0
    8f80:	3a000005 	bcc	8f9c <__udivdi3+0x90>
    8f84:	e3a08001 	mov	r8, #1
    8f88:	e0544006 	subs	r4, r4, r6
    8f8c:	e1a01e18 	lsl	r1, r8, lr
    8f90:	e1811c38 	orr	r1, r1, r8, lsr ip
    8f94:	e0c55007 	sbc	r5, r5, r7
    8f98:	e1a00318 	lsl	r0, r8, r3
    8f9c:	e3530000 	cmp	r3, #0
    8fa0:	0a00001f 	beq	9024 <__udivdi3+0x118>
    8fa4:	e1b070a7 	lsrs	r7, r7, #1
    8fa8:	e1a06066 	rrx	r6, r6
    8fac:	ea000007 	b	8fd0 <__udivdi3+0xc4>
    8fb0:	e0544006 	subs	r4, r4, r6
    8fb4:	e0c55007 	sbc	r5, r5, r7
    8fb8:	e0944004 	adds	r4, r4, r4
    8fbc:	e0a55005 	adc	r5, r5, r5
    8fc0:	e2944001 	adds	r4, r4, #1
    8fc4:	e2a55000 	adc	r5, r5, #0
    8fc8:	e2533001 	subs	r3, r3, #1
    8fcc:	0a000006 	beq	8fec <__udivdi3+0xe0>
    8fd0:	e1570005 	cmp	r7, r5
    8fd4:	01560004 	cmpeq	r6, r4
    8fd8:	9afffff4 	bls	8fb0 <__udivdi3+0xa4>
    8fdc:	e0944004 	adds	r4, r4, r4
    8fe0:	e0a55005 	adc	r5, r5, r5
    8fe4:	e2533001 	subs	r3, r3, #1
    8fe8:	1afffff8 	bne	8fd0 <__udivdi3+0xc4>
    8fec:	e0948000 	adds	r8, r4, r0
    8ff0:	e0a59001 	adc	r9, r5, r1
    8ff4:	e1a03234 	lsr	r3, r4, r2
    8ff8:	e2621020 	rsb	r1, r2, #32
    8ffc:	e2420020 	sub	r0, r2, #32
    9000:	e1833115 	orr	r3, r3, r5, lsl r1
    9004:	e1a0c235 	lsr	ip, r5, r2
    9008:	e1833035 	orr	r3, r3, r5, lsr r0
    900c:	e1a0721c 	lsl	r7, ip, r2
    9010:	e1877013 	orr	r7, r7, r3, lsl r0
    9014:	e1a06213 	lsl	r6, r3, r2
    9018:	e1877133 	orr	r7, r7, r3, lsr r1
    901c:	e0580006 	subs	r0, r8, r6
    9020:	e0c91007 	sbc	r1, r9, r7
    9024:	e8bd47f0 	pop	{r4, r5, r6, r7, r8, r9, sl, lr}
    9028:	e12fff1e 	bx	lr

0000902c <__clzdi2>:
    902c:	e92d4010 	push	{r4, lr}
    9030:	e3510000 	cmp	r1, #0
    9034:	1a000002 	bne	9044 <__clzdi2+0x18>
    9038:	eb000005 	bl	9054 <__clzsi2>
    903c:	e2800020 	add	r0, r0, #32
    9040:	ea000001 	b	904c <__clzdi2+0x20>
    9044:	e1a00001 	mov	r0, r1
    9048:	eb000001 	bl	9054 <__clzsi2>
    904c:	e8bd4010 	pop	{r4, lr}
    9050:	e12fff1e 	bx	lr

00009054 <__clzsi2>:
    9054:	e3a0101c 	mov	r1, #28
    9058:	e3500801 	cmp	r0, #65536	; 0x10000
    905c:	21a00820 	lsrcs	r0, r0, #16
    9060:	22411010 	subcs	r1, r1, #16
    9064:	e3500c01 	cmp	r0, #256	; 0x100
    9068:	21a00420 	lsrcs	r0, r0, #8
    906c:	22411008 	subcs	r1, r1, #8
    9070:	e3500010 	cmp	r0, #16
    9074:	21a00220 	lsrcs	r0, r0, #4
    9078:	22411004 	subcs	r1, r1, #4
    907c:	e28f2008 	add	r2, pc, #8
    9080:	e7d20000 	ldrb	r0, [r2, r0]
    9084:	e0800001 	add	r0, r0, r1
    9088:	e12fff1e 	bx	lr
    908c:	02020304 	andeq	r0, r2, #4, 6	; 0x10000000
    9090:	01010101 	tsteq	r1, r1, lsl #2
	...
...
0000a08c <.ARM.exidx>:
    a08c:	7fffed08 	svcvc	0x00ffed08
...
00000000 <.debug_info>:
     ...
     870:	3b010400 	blcc	41878 <__bss_end+0x34878>
     874:	d0000005 	andle	r0, r0, r5
     878:	0c00008c 	stceq	0, cr0, [r0], {140}	; 0x8c
     ...
     928:	8d0c0000 	stchi	0, cr0, [ip, #-0]
     92c:	00840000 	addeq	r0, r4, r0
     930:	05990000 	ldreq	r0, [r9]
     ...
     948:	00008d0c 	andeq	r8, r0, ip, lsl #26
     ...
     990:	008d2807 	addeq	r2, sp, r7, lsl #16
     ...
     a18:	00008d6c 	andeq	r8, r0, ip, ror #26
     ...
     a80:	0005f801 	andeq	pc, r5, r1, lsl #16
     a84:	008d9000 	addeq	r9, sp, r0
     a88:	008d9400 	addeq	r9, sp, r0, lsl #8
     ...
     b3c:	00008d94 	muleq	r0, r4, sp
     b40:	00000178 	andeq	r0, r0, r8, ror r1
     b44:	00000653 	andeq	r0, r0, r3, asr r6
     ...
     cbc:	008d9400 	addeq	r9, sp, r0, lsl #8
     ...
     d40:	008dbc14 	addeq	fp, sp, r4, lsl ip
     ...
     da4:	008f0c00 	addeq	r0, pc, r0, lsl #24
     da8:	00012000 	andeq	r2, r1, r0
     dac:	0006eb00 	andeq	lr, r6, r0, lsl #22
     ...
     ebc:	008f0c00 	addeq	r0, pc, r0, lsl #24
     ...
     ee8:	00008f0c 	andeq	r8, r0, ip, lsl #30
     ...
     f5c:	7d010400 	cfstrsvc	mvf0, [r1, #-0]
     f60:	2c000007 	stccs	0, cr0, [r0], {7}
     f64:	54000090 	strpl	r0, [r0], #-144	; 0xffffff70
    ...
    100c:	0007e201 	andeq	lr, r7, r1, lsl #4
    1010:	00905400 	addseq	r5, r0, r0, lsl #8
    1014:	00909c00 	addseq	r9, r0, r0, lsl #24
...
00000000 <.debug_abbrev>:
 ...
 174:	0b002404 	bleq	918c <__clzsi2+0x138>
 ...
 26c:	0b002403 	bleq	9280 <__clzsi2+0x22c>
 ...
 3a8:	0b002403 	bleq	93bc <__clzsi2+0x368>
 ...
 544:	0b002402 	bleq	9554 <__clzsi2+0x500>
...
00000000 <.debug_aranges>:
 ...
 170:	00008d0c 	andeq	r8, r0, ip, lsl #26
 ...
 1d0:	00008f0c 	andeq	r8, r0, ip, lsl #30
 ...
 1f0:	0000902c 	andeq	r9, r0, ip, lsr #32
 ...
 210:	00009054 	andeq	r9, r0, r4, asr r0
...
00000000 <.debug_line>:
 ...
 4dc:	00005a01 	andeq	r5, r0, r1, lsl #20
 ...
 51c:	322f2f31 	eorcc	r2, pc, #49, 30	; 0xc4
 520:	2f302f31 	svccs	0x00302f31
 524:	2f312f30 	svccs	0x00312f30
 528:	302f3130 	eorcc	r3, pc, r0, lsr r1	; <UNPREDICTABLE>
 52c:	312f2f30 			; <UNDEFINED> instruction: 0x312f2f30
 530:	302f2f2f 	eorcc	r2, pc, pc, lsr #30
 534:	02022f30 	andeq	r2, r2, #48, 30	; 0xc0
 538:	5a010100 	bpl	40940 <__bss_end+0x33940>
 53c:	02000000 	andeq	r0, r0, #0
 540:	00003d00 	andeq	r3, r0, r0, lsl #26
 544:	fb010200 	blx	40d4e <__bss_end+0x33d4e>
 548:	01000d0e 	tsteq	r0, lr, lsl #26
 54c:	00010101 	andeq	r0, r1, r1, lsl #2
 550:	00010000 	andeq	r0, r1, r0
 554:	2e2e0100 	sufcse	f0, f6, f0
 558:	2f2e2e2f 	svccs	0x002e2e2f
 55c:	732f2e2e 			; <UNDEFINED> instruction: 0x732f2e2e
 560:	6c2f6372 	stcvs	3, cr6, [pc], #-456	; 3a0 <__start-0x7c60>
 564:	63676269 	cmnvs	r7, #-1879048186	; 0x90000006
 568:	6f632f63 	svcvs	0x00632f63
 56c:	6769666e 	strbvs	r6, [r9, -lr, ror #12]!
 570:	6d72612f 	ldfvse	f6, [r2, #-188]!	; 0xffffff44
 574:	70620000 	rsbvc	r0, r2, r0
 578:	2e696261 	cdpcs	2, 6, cr6, cr9, cr1, {3}
 57c:	00010053 	andeq	r0, r1, r3, asr r0
 580:	05000000 	streq	r0, [r0, #-0]
 584:	008cd002 	addeq	sp, ip, r2
 588:	019b0300 	orrseq	r0, fp, r0, lsl #6
 58c:	3133f401 	teqcc	r3, r1, lsl #8	; <UNPREDICTABLE>
 590:	2f2f2f2f 	svccs	0x002f2f2f
 594:	01000202 	tsteq	r0, r2, lsl #4
 598:	00005b01 	andeq	r5, r0, r1, lsl #22
 59c:	3d000200 	sfmcc	f0, 4, [r0, #-0]
 5a0:	02000000 	andeq	r0, r0, #0
 5a4:	0d0efb01 	vstreq	d15, [lr, #-4]
 5a8:	01010100 	mrseq	r0, (UNDEF: 17)
 5ac:	00000001 	andeq	r0, r0, r1
 5b0:	01000001 	tsteq	r0, r1
 5b4:	2e2f2e2e 	cdpcs	14, 2, cr2, cr15, cr14, {1}
 5b8:	2e2e2f2e 	cdpcs	15, 2, cr2, cr14, cr14, {1}
 5bc:	6372732f 	cmnvs	r2, #-1140850688	; 0xbc000000
 5c0:	62696c2f 	rsbvs	r6, r9, #12032	; 0x2f00
 5c4:	2f636367 	svccs	0x00636367
 5c8:	666e6f63 	strbtvs	r6, [lr], -r3, ror #30
 5cc:	612f6769 			; <UNDEFINED> instruction: 0x612f6769
 5d0:	00006d72 	andeq	r6, r0, r2, ror sp
 5d4:	62617062 	rsbvs	r7, r1, #98	; 0x62
 5d8:	00632e69 	rsbeq	r2, r3, r9, ror #28
 5dc:	00000001 	andeq	r0, r0, r1
 5e0:	0c020500 	cfstr32eq	mvfx0, [r2], {-0}
 5e4:	0300008d 	movweq	r0, #141	; 0x8d
 5e8:	a12e0125 			; <UNDEFINED> instruction: 0xa12e0125
 5ec:	2e50d84b 	cdpcs	8, 5, cr13, cr0, cr11, {2}
 5f0:	02d82fa1 	sbcseq	r2, r8, #644	; 0x284
 5f4:	01010004 	tsteq	r1, r4
 5f8:	00000057 	andeq	r0, r0, r7, asr r0
 5fc:	00410002 	subeq	r0, r1, r2
 600:	01020000 	mrseq	r0, (UNDEF: 2)
 604:	000d0efb 	strdeq	r0, [sp], -fp
 608:	01010101 	tsteq	r1, r1, lsl #2
 60c:	01000000 	mrseq	r0, (UNDEF: 0)
 610:	2e010000 	cdpcs	0, 0, cr0, cr1, cr0, {0}
 614:	2e2e2f2e 	cdpcs	15, 2, cr2, cr14, cr14, {1}
 618:	2f2e2e2f 	svccs	0x002e2e2f
 61c:	2f637273 	svccs	0x00637273
 620:	6762696c 	strbvs	r6, [r2, -ip, ror #18]!
 624:	632f6363 			; <UNDEFINED> instruction: 0x632f6363
 628:	69666e6f 	stmdbvs	r6!, {r0, r1, r2, r3, r5, r6, r9, sl, fp, sp, lr}^
 62c:	72612f67 	rsbvc	r2, r1, #412	; 0x19c
 630:	6c00006d 	stcvs	0, cr0, [r0], {109}	; 0x6d
 634:	66316269 	ldrtvs	r6, [r1], -r9, ror #4
 638:	73636e75 	cmnvc	r3, #1872	; 0x750
 63c:	0100532e 	tsteq	r0, lr, lsr #6
 640:	00000000 	andeq	r0, r0, r0
 644:	8d900205 	lfmhi	f0, 4, [r0, #20]
 648:	ae030000 	cdpge	0, 0, cr0, cr3, cr0, {0}
 64c:	0202010b 	andeq	r0, r2, #-1073741822	; 0xc0000002
 650:	94010100 	strls	r0, [r1], #-256	; 0xffffff00
 654:	02000000 	andeq	r0, r0, #0
 658:	00004100 	andeq	r4, r0, r0, lsl #2
 65c:	fb010200 	blx	40e66 <__bss_end+0x33e66>
 660:	01000d0e 	tsteq	r0, lr, lsl #26
 664:	00010101 	andeq	r0, r1, r1, lsl #2
 668:	00010000 	andeq	r0, r1, r0
 66c:	2e2e0100 	sufcse	f0, f6, f0
 670:	2f2e2e2f 	svccs	0x002e2e2f
 674:	732f2e2e 			; <UNDEFINED> instruction: 0x732f2e2e
 678:	6c2f6372 	stcvs	3, cr6, [pc], #-456	; 4b8 <__start-0x7b48>
 67c:	63676269 	cmnvs	r7, #-1879048186	; 0x90000006
 680:	6c000063 	stcvs	0, cr0, [r0], {99}	; 0x63
 684:	63676269 	cmnvs	r7, #-1879048186	; 0x90000006
 688:	632e3263 			; <UNDEFINED> instruction: 0x632e3263
 68c:	00000100 	andeq	r0, r0, r0, lsl #2
 690:	6762696c 	strbvs	r6, [r2, -ip, ror #18]!
 694:	2e326363 	cdpcs	3, 3, cr6, cr2, cr3, {3}
 698:	00010068 	andeq	r0, r1, r8, rrx
 69c:	05000000 	streq	r0, [r0, #-0]
 6a0:	008d9402 	addeq	r9, sp, r2, lsl #8
 6a4:	09cb0300 	stmibeq	fp, {r8, r9}^
 6a8:	7a031801 	bvc	c66b4 <__bss_end+0xb96b4>
 6ac:	3133672e 	teqcc	r3, lr, lsr #14
 6b0:	827de803 	rsbshi	lr, sp, #196608	; 0x30000
 6b4:	2f2d67a0 	svccs	0x002d67a0
 6b8:	03a52f4c 			; <UNDEFINED> instruction: 0x03a52f4c
 6bc:	03352e79 	teqeq	r5, #1936	; 0x790
 6c0:	6f032e79 	svcvs	0x00032e79
 6c4:	4a18032e 	bmi	601384 <__user_program+0x301384>
 6c8:	492f2d31 	stmdbmi	pc!, {r0, r4, r5, r8, sl, fp, sp}	; <UNPREDICTABLE>
 6cc:	6e4c312f 	dvfvsep	f3, f4, #10.0
 6d0:	4c6945be 	cfstr64mi	mvdx4, [r9], #-760	; 0xfffffd08
 6d4:	832f494f 			; <UNDEFINED> instruction: 0x832f494f
 6d8:	fa033064 	blx	cc870 <__bss_end+0xbf870>
 6dc:	033c0801 	teqeq	ip, #65536	; 0x10000
 6e0:	2f2d8279 	svccs	0x002d8279
 6e4:	04024947 	streq	r4, [r2], #-2375	; 0xfffff6b9
 6e8:	8e010100 	adfhis	f0, f1, f0
 6ec:	02000000 	andeq	r0, r0, #0
 6f0:	00004100 	andeq	r4, r0, r0, lsl #2
 6f4:	fb010200 	blx	40efe <__bss_end+0x33efe>
 ...
 718:	6c000063 	stcvs	0, cr0, [r0], {99}	; 0x63
 71c:	63676269 	cmnvs	r7, #-1879048186	; 0x90000006
 720:	632e3263 			; <UNDEFINED> instruction: 0x632e3263
 724:	00000100 	andeq	r0, r0, r0, lsl #2
 728:	6762696c 	strbvs	r6, [r2, -ip, ror #18]!
 72c:	2e326363 	cdpcs	3, 3, cr6, cr2, cr3, {3}
 730:	00010068 	andeq	r0, r1, r8, rrx
 734:	05000000 	streq	r0, [r0, #-0]
 738:	008f0c02 	addeq	r0, pc, r2, lsl #24
 73c:	0a860300 	beq	fe181344 <__user_program+0xfde81344>
 740:	7db60301 	ldcvc	3, cr0, [r6, #4]!
 744:	02ca0301 	sbceq	r0, sl, #67108864	; 0x4000000
 748:	ab032e4a 	blge	cc078 <__bss_end+0xbf078>
 74c:	0b03827d 	bleq	e1148 <__bss_end+0xd4148>
 750:	2d67304a 	stclcs	0, cr3, [r7, #-296]!	; 0xfffffed8
 754:	a52f4c2f 	strge	r4, [pc, #-3119]!	; fffffb2d <__user_program+0xffcffb2d>
 758:	352e7903 	strcc	r7, [lr, #-2307]!	; 0xfffff6fd
 75c:	032e7903 			; <UNDEFINED> instruction: 0x032e7903
 760:	18032e6f 	stmdane	r3, {r0, r1, r2, r3, r5, r6, r9, sl, fp, sp}
 764:	2f2d314a 	svccs	0x002d314a
 768:	4c312f49 	ldcmi	15, cr2, [r1], #-292	; 0xfffffedc
 76c:	6945be6e 	stmdbvs	r5, {r1, r2, r3, r5, r6, r9, sl, fp, ip, sp, pc}^
 770:	bb4b4e4c 	bllt	12d40a8 <__user_program+0xfd40a8>
 774:	ba02a503 	blt	a9b88 <__bss_end+0x9cb88>
 778:	01000402 	tsteq	r0, r2, lsl #8
 77c:	00006101 	andeq	r6, r0, r1, lsl #2
 780:	41000200 	mrsmi	r0, R8_usr
 784:	02000000 	andeq	r0, r0, #0
 788:	0d0efb01 	vstreq	d15, [lr, #-4]
 78c:	01010100 	mrseq	r0, (UNDEF: 17)
 ...
 7a0:	6372732f 	cmnvs	r2, #-1140850688	; 0xbc000000
 7a4:	62696c2f 	rsbvs	r6, r9, #12032	; 0x2f00
 7a8:	2f636367 	svccs	0x00636367
 7ac:	666e6f63 	strbtvs	r6, [lr], -r3, ror #30
 7b0:	612f6769 			; <UNDEFINED> instruction: 0x612f6769
 7b4:	00006d72 	andeq	r6, r0, r2, ror sp
 7b8:	3162696c 	cmncc	r2, ip, ror #18
 7bc:	636e7566 	cmnvs	lr, #427819008	; 0x19800000
 7c0:	00532e73 	subseq	r2, r3, r3, ror lr
 7c4:	00000001 	andeq	r0, r0, r1
 7c8:	2c020500 	cfstr32cs	mvfx0, [r2], {-0}
 7cc:	03000090 	movweq	r0, #144	; 0x90
 7d0:	30010dae 	andcc	r0, r1, lr, lsr #27
 7d4:	2e09032f 	cdpcs	3, 0, cr0, cr9, cr15, {1}
 7d8:	2f302f2f 	svccs	0x00302f2f
 7dc:	00040234 	andeq	r0, r4, r4, lsr r2
 7e0:	00640101 	rsbeq	r0, r4, r1, lsl #2
 7e4:	00020000 	andeq	r0, r2, r0
 7e8:	00000041 	andeq	r0, r0, r1, asr #32
 7ec:	0efb0102 	cdpeq	1, 15, cr0, cr11, cr2, {0}
 7f0:	0101000d 	tsteq	r1, sp
 7f4:	00000101 	andeq	r0, r0, r1, lsl #2
 7f8:	00000100 	andeq	r0, r0, r0, lsl #2
 7fc:	2f2e2e01 	svccs	0x002e2e01
 800:	2e2f2e2e 	cdpcs	14, 2, cr2, cr15, cr14, {1}
 804:	72732f2e 	rsbsvc	r2, r3, #46, 30	; 0xb8
 808:	696c2f63 	stmdbvs	ip!, {r0, r1, r5, r6, r8, r9, sl, fp, sp}^
 80c:	63636762 	cmnvs	r3, #25690112	; 0x1880000
 810:	6e6f632f 	cdpvs	3, 6, cr6, cr15, cr15, {1}
 814:	2f676966 	svccs	0x00676966
 818:	006d7261 	rsbeq	r7, sp, r1, ror #4
 81c:	62696c00 	rsbvs	r6, r9, #0, 24
 820:	6e756631 	mrcvs	6, 3, r6, cr5, cr1, {1}
 824:	532e7363 			; <UNDEFINED> instruction: 0x532e7363
 828:	00000100 	andeq	r0, r0, r0, lsl #2
 82c:	02050000 	andeq	r0, r5, #0
 830:	00009054 	andeq	r9, r0, r4, asr r0
 834:	010d8d03 	tsteq	sp, r3, lsl #26
 838:	2f2f302f 	svccs	0x002f302f
 83c:	302f2f30 	eorcc	r2, pc, r0, lsr pc	; <UNPREDICTABLE>
 840:	2f2f2f2f 	svccs	0x002f2f2f
 844:	000a022f 	andeq	r0, sl, pc, lsr #4
...
00000000 <.debug_frame>:
 ...
 2f4:	00008d0c 	andeq	r8, r0, ip, lsl #26
 ...
 324:	00008d50 	andeq	r8, r0, r0, asr sp
 ...
 3a4:	00008f0c 	andeq	r8, r0, ip, lsl #30
